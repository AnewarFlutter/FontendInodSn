...
exports.generateModuleEnums = generateModuleEnums;
 ...
 */
function generateModuleEnums(module, project) {
    ...
    const enumsDir = path_1.default.join(root, "modules", module.$name, "enums");
    ...
    enums
        ...
        fs_1.default.writeFileSync(path_1.default.join(enumsDir, file), templates_base_1.T.enumBlock(module.$name, e) + "\n");
    ...
    enums
        ...
        const content = templates_base_1.T.enumBlock(module.$name, e) + "\n";
    ...
    const mergedFileName = `${(0, file_name_1.getFileName)(casing, `${module.$name}_enums`)}.ts`;
    ...
    merged.forEach((e) => {
        newEnumBlocks.set(e.$name, templates_base_1.T.enumBlock(module.$name, e));
    });
