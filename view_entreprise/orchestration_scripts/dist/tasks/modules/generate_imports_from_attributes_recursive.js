...
exports.generateImportsFromAttributesRecursive = generateImportsFromAttributesRecursive;
const resolve_import_paths_1 = require("../../utils/functions/module/imports/resolve_import_paths");
function generateImportsFromAttributesRecursive(attrs, currentModule, currentFeature, config, context, imports = new Map(), visited = new Set() // pour éviter les boucles infinies
) {
    attrs.forEach(attr => {
            ...
            try {
                ...
                if (related.$kind === "custom" || related.$kind === "entity" || related.$kind === "enum") {
                    ...
                    if (relatedAttrs && relatedAttrs.length > 0) {
                        ...
                        generateImportsFromAttributesRecursive(relatedAttrs, relatedModule, relatedFeature ?? { $name: "" }, config, context, imports, visited);
                    }
                }
            }
            catch (e) {
