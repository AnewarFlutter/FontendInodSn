import { UsecaseImportSchema, ModuleSchema, ModulesConfigSchema } from "../../../../config_validator";
 ...
 */
export function resolveImportPathForCustomType(
    ...
    if (targetFeatureName && typeof targetFeatureName === "string") {
        ...
        const featureFile = getFileName(casing, targetFeatureName);
