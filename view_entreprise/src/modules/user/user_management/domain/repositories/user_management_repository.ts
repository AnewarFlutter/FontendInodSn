...
/**
 * UserManagementRepository – Contrat de persistance pour l'entité UserManagement
 * 
 * **Rôle** : Interface abstraite utilisée par les UseCases.
 * 
 * **Implémentations** :
 * - `UserManagementRepositoryImpl` (couche data)
 * - Mock pour tests
 * 
 * **Généré automatiquement** à partir des UseCases du module **user**.
 * 
 * @example
 * const repo: UserManagementRepository = container.get(UserManagementRepository);
