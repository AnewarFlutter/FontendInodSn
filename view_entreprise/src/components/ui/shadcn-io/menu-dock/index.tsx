...
export const MenuDock: React.FC<MenuDockProps> = ({
  ...
  // Utiliser l'index contrôlé si fourni, sinon utiliser l'index interne
  ...
  useEffect(() => {
      if (activeIndex >= finalItems.length && controlledActiveIndex === undefined) {
          ...
          >
            ...
            {showLabels && (
              <span
                ...
                className={cn(
                  'font-medium transition-all duration-200 capitalize',
                  styles.text,
                  'whitespace-nowrap',
